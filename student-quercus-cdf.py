...
if __name__ == '__main__': 
    ...
    #print(utorid_to_quercus_line)
    #print(utorid_to_cdf_file_line_dict)

    # find the lines that match the query
    matched_utorid = {}
    ...
    # yeah but want to search emails too.. those are in CDF file
    ...
    #print(matched_utorid.keys())
    
    # first line of quercus csv file names each column, so we can use that to get index of section
    lines_to_display = []
    full_quercus_lines = []
