...
if __name__ == '__main__': 
    ...
    def select_student_field(utorid):
    ...
    (q_line,cdf_line) = read_course_files()
    dropped_utorid = drops()
    ...
    utorid = select_student_menu()
    selected_field = select_student_field(utorid)
